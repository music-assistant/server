...
def main() -> int:
    ...
    for req_str in core_reqs + extra_reqs:
        ...
        # Append variant suffix (e.g. +cpu) for packages pinned to alternate indices
        final_req = (
            req_str + pkg_suffixes[package_name] if package_name in pkg_suffixes else req_str
        )

        final_requirements[package_name] = final_req
