...
def main() -> int:
    ...
    if extra_urls:
        ...
        # Allow uv to find the best version across all indexes instead of
        # stopping at the first index that contains a package name.
        # See: https://docs.astral.sh/uv/pip/compatibility/#packages-that-exist-on-multiple-indexes
        content += "--index-strategy unsafe-best-match\n"
    content += "\n"
