"""Test KION Music Recommendations."""
...
def provider_mock() -> Mock:
    """Return a mock KION Music provider."""
    provider = Mock(spec=KionMusicProvider)
    provider.domain = "kion_music"
    provider.instance_id = "kion_music_instance"
...
async def test_get_my_wave_recommendations_success(provider_mock: Mock) -> None:
    ...
    mock_parsed_track.item_id = f"12345{RADIO_TRACK_ID_SEP}{ROTOR_STATION_MY_MIX}"
    ...
    result = await KionMusicProvider._get_my_wave_recommendations(provider_mock)
...
async def test_get_feed_recommendations_success(provider_mock: Mock) -> None:
    ...
    with patch(
        "music_assistant.providers.kion_music.provider.parse_playlist",
        return_value=mock_parsed_playlist,
    ):
        result = await KionMusicProvider._get_feed_recommendations(provider_mock)
...
async def test_get_chart_recommendations_success(provider_mock: Mock) -> None:
    ...
    with patch(
        "music_assistant.providers.kion_music.provider.parse_track",
        return_value=mock_parsed_track,
    ):
        result = await KionMusicProvider._get_chart_recommendations(provider_mock)
...
async def test_get_new_releases_recommendations_success(provider_mock: Mock) -> None:
    ...
    with patch(
        "music_assistant.providers.kion_music.provider.parse_album",
        return_value=mock_parsed_album,
    ):
        result = await KionMusicProvider._get_new_releases_recommendations(provider_mock)
...
async def test_get_new_playlists_recommendations_success(provider_mock: Mock) -> None:
    ...
    with patch(
        ...
        result = await KionMusicProvider._get_new_playlists_recommendations(provider_mock)
...
async def test_get_top_picks_recommendations_success(provider_mock: Mock) -> None:
    ...
    with patch(
        ...
        result = await KionMusicProvider._get_top_picks_recommendations(provider_mock)
...
async def test_get_mood_mix_recommendations_success(provider_mock: Mock) -> None:
    ...
    with patch(
        ...
        result = await KionMusicProvider._get_mood_mix_recommendations(provider_mock, "chill")
...
async def test_get_mood_mix_recommendations_empty(provider_mock: Mock) -> None:
    ...
    result = await KionMusicProvider._get_mood_mix_recommendations(provider_mock, "sad")
...
async def test_get_mood_mix_recommendations_invalid_data_error(provider_mock: Mock) -> None:
    ...
    with patch(
        ...
        result = await KionMusicProvider._get_mood_mix_recommendations(provider_mock, "romantic")
...
async def test_get_activity_mix_recommendations_success(provider_mock: Mock) -> None:
    ...
    with patch(
        ...
        result = await KionMusicProvider._get_activity_mix_recommendations(
...
async def test_get_activity_mix_recommendations_empty(provider_mock: Mock) -> None:
    ...
    result = await KionMusicProvider._get_activity_mix_recommendations(provider_mock, "focus")
...
async def test_get_seasonal_mix_recommendations_winter(provider_mock: Mock) -> None:
    ...
    with (
        patch("music_assistant.providers.kion_music.provider.datetime", mock_datetime),
        patch(
            "music_assistant.providers.kion_music.provider.parse_playlist",
            return_value=mock_parsed_playlist,
        ),
    ):
        result = await KionMusicProvider._get_seasonal_mix_recommendations(provider_mock)
...
async def test_get_seasonal_mix_recommendations_empty(provider_mock: Mock) -> None:
    ...
    with patch("music_assistant.providers.kion_music.provider.datetime", mock_datetime):
        result = await KionMusicProvider._get_seasonal_mix_recommendations(provider_mock)
...
async def test_recommendations_aggregates_all_folders(provider_mock: Mock) -> None:
    ...
    result = await KionMusicProvider.recommendations(provider_mock)
