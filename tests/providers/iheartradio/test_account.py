...
async def test_guest_session_without_credentials(
    ...
    persist = Mock()
    provider._update_setup_data = persist  # type: ignore[method-assign]
    ...
    persisted = {call.args[0]: call.args[1] for call in persist.call_args_list}
    assert persisted == {
        CONF_PROFILE_ID: "1",
