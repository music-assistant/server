...
@pytest.mark.parametrize(
    ...
    [
        ...
        (LibraryRowID.RECENTLY_ADDED_TRACKS, "tracks", "provider"),
        (LibraryRowID.RECENTLY_ADDED_ALBUMS, "albums", "provider"),
        (LibraryRowID.RANDOM_ARTISTS, "artists", "provider"),
        (LibraryRowID.RANDOM_ALBUMS, "albums", "provider"),
        (LibraryRowID.RECENT_FAVORITE_TRACKS, "tracks", "provider"),
        (LibraryRowID.FAVORITE_PLAYLISTS, "playlists", "provider"),
        (LibraryRowID.FAVORITE_RADIO, "radio", "provider"),
        (LibraryRowID.FORGOTTEN_TRACKS, "tracks", "provider"),
        (LibraryRowID.FORGOTTEN_ALBUMS, "albums", "provider"),
        (LibraryRowID.FORGOTTEN_ARTISTS, "artists", "provider"),
        (LibraryRowID.MOST_PLAYED_TRACKS, "tracks", "provider"),
        (LibraryRowID.NEVER_PLAYED_TRACKS, "tracks", "provider"),
    ],
)
