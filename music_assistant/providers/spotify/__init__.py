...
from .helpers import get_config_entries, get_librespot_binary
...
# Expose functions that Music Assistant expects at module level
...
class SpotifyProvider(MusicProvider):
    ...
    def played_threshold(self) -> float:
        ...
        value = self.config.get_value(CONF_PLAYED_THRESHOLD, 0.8)
        if isinstance(value, (int, float)):
            ...
            return 0.8  # fallback to default for any other type
