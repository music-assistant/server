...
from .connect_redirect import SpotifyConnectRedirect
...
class SpotifyProvider(MusicProvider):
    ...
    _connect_redirect: SpotifyConnectRedirect
    ...
    async def handle_async_init(self) -> None:
        ...
        self._connect_redirect = SpotifyConnectRedirect(self)
    ...
    async def get_playback_delegate(self, target_player_id: str) -> AudioSource | None:
        ...
        if self._sp_user is None:
            return None
        if self._connect_mode:
            return await self._connect_redirect.find_connect_delegate(target_player_id)
        return await self._connect_redirect.find_active_connect_delegate(target_player_id)
    ...
    async def play_on_delegate(
        ...
        """
        await self._connect_redirect.play_on_delegate(
            delegate,
            media_items,
            option,
            target_player_id,
