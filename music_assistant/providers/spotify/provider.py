...
class SpotifyProvider(MusicProvider):
    ...
    @use_cache(86400 * 365, use_expired_cache=True)  # 1 year - album track listings are immutable
    ...
    @use_cache(3600 * 3, use_expired_cache=True)  # 3 hours
    ...
    @use_cache(86400 * 14, use_expired_cache=True)  # 14 days
