...
async def get_config_entries_impl(
    ...
    return (
        ...
        ConfigEntry(
            ...
            required=False,
            description=(
                "Enter the 6-digit confirmation code generated by your 2-step verification app."
            ),
        ),
        ConfigEntry(
        ...
        ConfigEntry(
            ...
            description=(
                ...
                "Note: Even if 'No filtering' is selected, "
                "NicoNico may still apply filtering on their side."
            ),
            category="content",
        ),
        ConfigEntry(
            ...
            description=(
                ...
                "This helps keep your NicoNico account synchronized with your music preferences."
            ),
            category="content",
        ),
        ConfigEntry(
