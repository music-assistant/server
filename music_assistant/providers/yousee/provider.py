...
class YouSeeMusikProvider(MusicProvider):
    ...
    @use_cache(3600 * 24 * 14, use_expired_cache=True)  # Cache for 14 days
    ...
    @use_cache(3600 * 24 * 30, use_expired_cache=True)  # Cache for 30 days
    ...
    @use_cache(3600 * 3, use_expired_cache=True)  # Cache for 3 hours
    ...
    @use_cache(3600 * 24, use_expired_cache=True)  # Cache for 24 hours
