...
from music_assistant.controllers.media.genres import BASE_GENRES
...
class TestProvider(MusicProvider):
    ...
    async def get_track(self, prov_track_id: str) -> Track:
        ...
        genre = random.Random(artist_idx).choice(BASE_GENRES)
        return Track(
    ...
    async def get_artist(self, prov_artist_id: str) -> Artist:
        ...
        genre = random.Random(prov_artist_id).choice(BASE_GENRES)
        return Artist(
    ...
    async def get_podcast(self, prov_podcast_id: str) -> Podcast:
        ...
        genre = random.Random(prov_podcast_id).choice(BASE_GENRES)
        return Podcast(
    ...
    async def get_audiobook(self, prov_audiobook_id: str) -> Audiobook:
        ...
        genre = random.Random(prov_audiobook_id).choice(BASE_GENRES)
        return Audiobook(
    ...
    async def get_album_tracks(self, prov_album_id: str) -> list[Track]:
        ...
        for track_idx in range(num_tracks):
            ...
            tracks.append(await self.get_track(track_item_id))
        return tracks
    ...
    async def get_podcast_episode(self, prov_episode_id: str) -> PodcastEpisode:
        ...
        genre = random.Random(podcast_id).choice(BASE_GENRES)
