"""Setup flow for the Mamma Mi Radio provider."""
...
from music_assistant.providers.mammamiradio import CONF_MAMMAMIRADIO_URL, DEFAULT_URL
...
async def run_setup(session: SetupSession) -> None:
    """Run the setup flow: collect the Mamma Mi Radio URL and create the provider."""
