...
4. **Issue 14:** ~~Simplify podcast episode caching~~ — Done (reduced TTL to 1h, added docstring)
5. **Issue 12:** ~~Cache personal songs~~ — Done (@use_cache 24h, full pagination)
6. **Issue 18:** Document serialization workaround, file upstream issue — Awaiting feedback
