...
from music_assistant.helpers.hls import HLSPlaylistParser, HLSPlaylistStructure
...
class NicovideoStreamData:
    ...
    domand_bid: str
    parsed_hls_playlist: HLSPlaylistStructure
...
class NicovideoStreamConverter(NicovideoConverterBase):
    ...
    def convert_from_conversion_data(self, conversion_data: StreamConversionData) -> StreamDetails:
        ...
        parsed_playlist = HLSPlaylistParser.parse(conversion_data.hls_playlist_text)
