...
class QQMusicProvider(MusicProvider):
    ...
    @use_cache(3600 * 12, use_expired_cache=True)
    ...
    @use_cache(3600 * 6, use_expired_cache=True)
    ...
    @use_cache(3600 * 24 * 7, use_expired_cache=True)
    ...
    @use_cache(3600, use_expired_cache=True)
    ...
    @use_cache(3600 * 24, use_expired_cache=True)
