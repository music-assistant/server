"""Media retrieval operations for the 24-7 (247e) music backend."""
...
class Music247eMediaManager:
    """Handles retrieval of media items from the 24-7 (247e) music backend."""
    ...
    async def get_playlist_tracks(
        ...
        if page > 0:
            ...
            return []
        # TODO: access the underlying paging on the 247e api (if possible))
