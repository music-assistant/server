...
# Warning shown on a Cast device's Sendspin output once the device reported it cannot run
# the receiver. Doubles as the value of CONF_PROTOCOL_EXPERIMENTAL_NOTE on that output.
