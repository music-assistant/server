...
therefore pushes the linked player's live volume over REST when a session is claimed
(source selected on a player) and again on re-activation of an already-claimed session,
