"""PlayerController: Orchestrates all players from player providers."""
...
from music_assistant.music.models import MediaItem, MediaType
from music_assistant.controllers.player.player import (
    Player,
    PlayerControl,
    PlayerControlType,
    PlayerState,
)
from music_assistant.controllers.player_queue import PlayerQueue, QueueItem, QueueOption
...
class PlayerController:
    """Controller holding and managing Players."""
    ...
    async def add_player(self, player: Player) -> None:
        ...
        self.mass.signal_event(EVENT_PLAYER_ADDED, player.calculated_state)
