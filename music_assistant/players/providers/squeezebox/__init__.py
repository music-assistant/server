...
from music_assistant.controllers.player.player import DeviceInfo, Player, PlayerFeature, PlayerState
from music_assistant.controllers.player_queue import QueueItem
...
class PySqueezeProvider(PlayerProvider):
    ...
    async def _client_connected(self, reader, writer):
        ...
        def handle_event(event: SqueezeEvent, socket_client: SqueezeSocketClient):
            ...
            # just update, the PlayerController will take care of adding it if it's a new player
