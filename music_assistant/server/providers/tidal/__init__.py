        ...
        artist = Artist(
            ...
            provider_mappings={
                ProviderMapping(
                    ...
                    url=f"https://www.tidal.com/artist/{artist_id}",
                )
            },
        )
        # metadata
        ...
        album = Album(
            ...
            provider_mappings={
                ProviderMapping(
                    ...
                    url=f"https://www.tidal.com/album/{album_id}",
        ...
        track = track_class(
            ...
            provider_mappings={
                ProviderMapping(
                    ...
                    url=f"https://www.tidal.com/track/{track_id}",
        ...
        playlist = Playlist(
            ...
            provider_mappings={
                ProviderMapping(
                    ...
                    provider_domain=self.domain,
                    provider_instance=self.instance_id,
                    url=f"https://www.tidal.com/playlist/{playlist_id}",
                )
            },
        )
