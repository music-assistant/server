...
class AudioBuffer:
    ...
    Chunks are stored in a list where index = second position.
    """
    ...
    def __init__(
        ...
        # Store chunks as a simple list where index = second position
        ...
        self._last_access_time: float = time.time()  # Initialize to current time
