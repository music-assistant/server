...
DB_TABLE_ALIASES: Final[str] = "aliases"
DB_TABLE_GENRE_ALIAS_MAPPING: Final[str] = "genre_alias_mapping"
DB_TABLE_ALIAS_MEDIA_ITEM_MAPPING: Final[str] = "alias_media_item_mapping"
